        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelefonoTienda = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HorarioTienda = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnlaceTelegram = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnlaceFacebook = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnlaceWhatsapp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnlaceInstagram = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FechaCreado = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreadoPor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FechaActualizado = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ActualizadoPor = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductoVarianteId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FechaCreado = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreadoPor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FechaActualizado = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ActualizadoPor = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProductoVarianteId1,
                        principalTable: "ProductoVariantes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "", "1.1.01", "", null, true, true, new DateTime(2026, 1, 23, 16, 43, 48, 439, DateTimeKind.Local).AddTicks(957), new DateTime(2026, 1, 23, 16, 43, 48, 439, DateTimeKind.Local).AddTicks(900), "Caja" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "", "5.1.01", "", null, true, true, new DateTime(2026, 1, 23, 16, 43, 48, 439, DateTimeKind.Local).AddTicks(984), new DateTime(2026, 1, 23, 16, 43, 48, 439, DateTimeKind.Local).AddTicks(982), "Gastos" },
                    { new Guid("44444444-4444-4444-4444-444444444444"), "", "4.1.01", "", null, true, true, new DateTime(2026, 1, 23, 16, 43, 48, 439, DateTimeKind.Local).AddTicks(990), new DateTime(2026, 1, 23, 16, 43, 48, 439, DateTimeKind.Local).AddTicks(989), "Ingresos por Ventas" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4129cf49-cc22-46a1-9625-501855f2da8b"), "", "", "Permite ver, crear, modificar y eliminar usuarios en el sistema.", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7842), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7841), "Gestionar usuarios" },
                    { new Guid("56b3924b-209b-40fb-9f31-ad75c12f4528"), "", "", "Permite ver los usuarios existentes en el sistema y sus datos.", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7830), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7829), "Listar usuarios" },
                    { new Guid("80abf232-a641-478d-8720-f0ae49e8a301"), "", "", "Permite ver los productos existentes en el sistema y sus datos.", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7858), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7857), "Listar Productos" },
                    { new Guid("80abf232-a641-478d-8720-f0ae49e8a302"), "", "", "Permite ver, crear, modificar y eliminar productos en el sistema.", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7865), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7864), "Gestionar Productos" },
                    { new Guid("90abf232-a641-478d-8720-f0ae49e8a306"), "", "", "Permite ver, crear, modificar y eliminar roles en el sistema.", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7852), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7851), "Gestionar rol" },
                    { new Guid("e36d283c-8b25-42b6-83bd-56edd953e770"), "", "", "Permite ver los roles existentes en el sistema y sus datos.", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7847), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7845), "Listar roles" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7729), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7673), "Administrador" },
                    { new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336523"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7755), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7753), "Vendedor" },
                    { new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336524"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7761), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(7759), "Cliente" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4129cf49-cc22-46a1-9625-501855f2da8b"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8114), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8113), new Guid("4129cf49-cc22-46a1-9625-501855f2da8b"), new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522") },
                    { new Guid("56b3924b-209b-40fb-9f31-ad75c12f4528"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8105), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8102), new Guid("56b3924b-209b-40fb-9f31-ad75c12f4528"), new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522") },
                    { new Guid("80abf232-a641-478d-8720-f0ae49e8a301"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8128), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8126), new Guid("80abf232-a641-478d-8720-f0ae49e8a301"), new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522") },
                    { new Guid("80abf232-a641-478d-8720-f0ae49e8a302"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8132), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8131), new Guid("80abf232-a641-478d-8720-f0ae49e8a302"), new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522") },
                    { new Guid("90abf232-a641-478d-8720-f0ae49e8a306"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8123), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8122), new Guid("90abf232-a641-478d-8720-f0ae49e8a306"), new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522") },
                    { new Guid("e36d283c-8b25-42b6-83bd-56edd953e770"), "", "", new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8119), new DateTime(2026, 1, 23, 16, 43, 48, 427, DateTimeKind.Local).AddTicks(8118), new Guid("e36d283c-8b25-42b6-83bd-56edd953e770"), new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("42717fb8-6e3f-4c94-b6b1-a88e8718d0a6"), "", "System", "AJhENXyR7dL9G9ctLAVPDj3e03G+gxsveDhJDa4KX1gnp4d37BB9usQgL7Y7gJdBzg==", "Admin@api.cu", "", false, true, new DateTime(2026, 1, 23, 16, 43, 48, 428, DateTimeKind.Local).AddTicks(4653), new DateTime(2026, 1, 23, 16, 43, 48, 428, DateTimeKind.Local).AddTicks(4627), "Admin", new Guid("c0b7e3b3-a06e-4580-b985-bb2fc4336522"), "11111111", "Admin" });
